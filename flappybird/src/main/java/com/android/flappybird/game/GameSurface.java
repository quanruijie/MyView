package com.android.flappybird.game;
...
import com.android.flappybird.game.layer.Background;
import com.android.flappybird.game.layer.Player;
import com.android.flappybird.game.layer.Start;
...
public class GameSurface extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private static int gameState;//游戏当前状态
    ...
    public GameSurface(Context content){
        super.(content);
        init();
    }
