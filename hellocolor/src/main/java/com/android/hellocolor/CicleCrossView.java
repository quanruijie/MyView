 ...
 * @time:2016/1/23 8:21
 */
public class CicleCrossView extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public CicleCrossView(Context context) {
        super(context);
        init();
    }

    public CicleCrossView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
